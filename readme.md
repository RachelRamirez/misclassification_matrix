...
#### Choosing to 'Try to Control 9T-4P' with One Lambda Values (Misclassification Cost on 9T_4P)
...
**Multiple Trends between Misclassifications and Accuracy and Lambda-Values**
...
### PreExperimentation: Choosing to 'Try to Control 9T-4P' with Multiple Lambdas and Epochs
